package cn.platform.core.advice;

import cn.platform.core.annotation.paramcheck.*;
 ...
 * @Description: 参数校验切面
 * @Package: cn.platform.core.advice
 * @ClassName: InputParamCheckAdvice
 * @Author: zhangmingyang
 * @CreateDate: 2018/8/16 10:47
 * @Version: 1.0
 */
public class InputParamCheckAdvice implements MethodBeforeAdvice {
    private static Logger logger = LoggerFactory.getLogger(InputParamCheckAdvice.class);
    ...
    private void paramCheck(Object inputParam) throws IllegalAccessException {
        if (inputParam instanceof BaseParam) {
