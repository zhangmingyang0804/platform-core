...
public class RSAUtils {
     ...
     * @throws Exception
     */
    public static synchronized String getPublicKey(Map<String, Object> keyMap) {
     ...
     * @return
     */
    private static byte[] decode(String strData) throws IOException {
    ...
    private static String encode(byte[] bytes) {
        ...
        String strEncoded = encoder.encode(bytes);
        return strEncoded.replaceAll("\r\n", "");
    }
